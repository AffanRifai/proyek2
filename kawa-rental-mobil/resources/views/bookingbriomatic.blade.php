...
<body>
  ...
  <header>
    ...
    <!-- mobil Section -->
    <main>
        <section class="product-detail" aria-label="Detail mobil Brio Matic">
            <div class="car-image">
                <img src="{{asset('img/BrioMatic.png')}}" alt="Mobil Brio Matic Kuning" />
            </div>
            <form class="car-info" aria-labelledby="carTitle">
                <h2 id="carTitle">Brio Matic</h2>
    ...
    <p>
        <strong>Honda Brio</strong> merupakan <strong>City Car / LCGC</strong> yang dikenal karena <strong>kelincahan</strong> dan <strong>efisiensi bahan bakarnya</strong> yang luar biasa. Mobil ini ideal untuk bermanuver di perkotaan dan menjadi pilihan populer untuk mobilitas sehari-hari.
    </p>
    <div>
    ...
    <div style="margin-top: 10px;">
        ...
        <ul>
            <li><strong>Tampilan Stylish dan Sporty:</strong> Brio memiliki desain yang modern, *compact*, dan menarik, dengan tampilan depan yang agresif yang memberikan kesan <strong>stylish</strong> dan <strong>enerjik</strong>.</li>
    ...
    <div style="margin-top: 10px;">
        ...
        <ul>
            ...
            <li><strong>Kapasitas Penumpang:</strong> Mampu menampung <strong>lima penumpang</strong> dengan nyaman.</li>
    ...
    <div style="margin-top: 10px;">
        ...
        <ul>
            ...
            <li><strong>Transmisi Otomatis jenis CVT (Continuously Variable Transmission):</strong>
                <ul>
                    <li><strong>Kenyamanan Berkendara:</strong> CVT menawarkan perpindahan gigi yang sangat **halus dan tanpa hentakan**, membuat pengalaman berkendara di kemacetan kota menjadi jauh lebih nyaman.</li>
                    <li><strong>Efisiensi:</strong> Teknologi CVT juga berperan besar dalam menjaga konsumsi bahan bakar agar tetap irit.</li>
                </ul>
            </li>
        </ul>
    </div>
    ...
    <div style="margin-top: 10px;">
        Honda Brio Satya Matic sangat ideal untuk disewa sebagai kendaraan:
        <ul>
            <li><strong>Kendaraan Komuter Harian:</strong> Sangat efisien dan mudah dikendarai di lalu lintas perkotaan.</li>
            <li><strong>Mobil Tugas Bisnis/Karyawan:</strong> Praktis, lincah, dan hemat biaya operasional.</li>
            <li><strong>Perjalanan Sendiri atau Pasangan:</strong> Kapasitas yang memadai untuk 1-4 orang dengan kenyamanan maksimal.</li>
        </ul>
    </div>
</div>
