    ...
    <div class="fitur-list">
      <div class="fitur-item">
        <span class="fitur-icon">
          <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#A62F19" viewBox="0 0 640 640">
      ...
      <div class="fitur-item">
        <span class="fitur-icon">
          <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#A62F19" class="bi bi-person-check-fill" viewBox="0 0 16 16">
      ...
      <div class="fitur-item">
        <span class="fitur-icon">
          <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#A62F19" class="bi bi-cash-coin" viewBox="0 0 16 16">
