...
<body>
    ...
    <div class="bungkus-tab">
        ...
        <div id="deskripsi" class="tab-content" style="display: block;">
            <p>
                <strong>Honda Mobilio</strong> merupakan <strong>Low MPV</strong> yang lincah dan irit bahan bakar,
                dirancang untuk memberikan kenyamanan dan kepraktisan maksimal bagi keluarga serta kebutuhan
                sehari-hari.
            </p>
            <div>
            ...
            <div style="margin-top: 10px;">
                ...
                <ul>
                    <li><strong>Tampilan Modern dan Dinamis:</strong> Mobilio memiliki desain yang sporty dan modern,
                        dengan garis bodi yang aerodinamis. Desain lampu depan (headlamp) yang tajam dan gril berlapis
                        krom (pada beberapa varian) memberikan kesan elegan di kelasnya.</li>
                    <li><strong>Dimensi Kompak:</strong> Sebagai Low MPV, Mobilio menawarkan dimensi yang ideal untuk
                        bermanuver di jalan perkotaan yang padat.
                        <ul>
                    ...
                    <li><strong>Ground Clearance Tinggi:</strong> Dengan jarak ke tanah yang cukup tinggi, Mobilio lebih
                        percaya diri melintasi jalan bergelombang atau genangan air.</li>
                </ul>
            </div>
            ...
            <div style="margin-top: 10px;">
                ...
                <ul>
                    <li><strong>Kabin Fleksibel 7 Penumpang:</strong> Mobilio didesain untuk menampung <strong>tujuh
                            penumpang</strong> (7-seater) dengan konfigurasi kursi 2-3-2.</li>
                    <li><strong>Akses Mudah ke Baris Ketiga:</strong> Kursi baris kedua dapat dilipat dengan mudah
                        (One-Touch Tumble) untuk memberikan akses yang praktis.</li>
                    <li><strong>AC Double Blower:</strong> Dilengkapi dengan sistem pendingin udara <strong>Double
                            Blower</strong> yang memastikan pendinginan merata hingga ke belakang.</li>
                    <li><strong>Bagasi Luas:</strong> Ketika kursi baris ketiga dilipat, Mobilio menawarkan ruang bagasi
                        yang sangat luas dan fleksibel, mampu menampung banyak barang bawaan.</li>
                </ul>
            </div>
            ...
            <div style="margin-top: 10px;">
                ...
                <ul>
                    <li><strong>Mesin Irit dan Bertenaga (i-VTEC):</strong> Ditenagai mesin bensin 4-silinder
                        <strong>1.5L SOHC i-VTEC</strong> yang terkenal efisien dan menghasilkan tenaga responsif.
                        <ul>
                            <li>Kapasitas: 1.496 cc.</li>
                            <li>Tenaga Maksimal: Sekitar 118 PS, salah satu yang terbesar di kelasnya.</li>
                        </ul>
                    </li>
                    <li><strong>Transmisi Manual yang Responsif:</strong> Unit dengan <strong>transmisi manual (biasanya
                            5 percepatan)</strong> memberikan pengemudi kontrol penuh atas akselerasi dan *engine
                        braking*, ideal untuk pengalaman berkendara yang *sporty* dan efisien saat melintasi rute
                        menanjak.</li>
                </ul>
            </div>
            ...
            <div style="margin-top: 10px;">
                ...
                <ul>
                    ...
                    <li><strong>Anti-lock Braking System (ABS)</strong> dan <strong>Electronic Brake-force Distribution
                            (EBD)</strong> untuk memastikan pengereman yang aman dan optimal, terutama dalam kondisi
                        darurat.</li>
                    <li><strong>Struktur Rangka G-CON + ACE™:</strong> Struktur bodi yang dirancang untuk meredam energi
                        benturan saat terjadi tabrakan.</li>
                    <li><strong>ISOFIX dan Tether:</strong> Tersedia fitur pengait kursi anak untuk keselamatan balita.
                    </li>
                </ul>
            </div>
            ...
            <div style="margin-top: 10px;">
                ...
                <ul>
                    <li><strong>Kendaraan Harian Keluarga:</strong> Irit dan praktis untuk mengantar anak sekolah atau
                        berbelanja.</li>
                    <li><strong>Perjalanan Luar Kota Ringan:</strong> Mesin 1.5L yang bertenaga menjamin performa yang
                        andal.</li>
                    <li><strong>Liburan Keluarga Kecil/Menengah:</strong> Kapasitas 7-seater memberikan fleksibilitas
                        tanpa perlu kendaraan yang terlalu besar.</li>
                </ul>
            </div>
        </div>
        ...
        <div id="syarat" class="tab-content">
            ...
            <ul style="padding-left: 20px; margin-top: 0; margin-bottom: 0;">
                ...
                <li style="margin-bottom: 5px;"><strong>Tanggung Jawab Kerusakan/Kehilangan:</strong> Segala resiko
                    ...
                    (Penyewa).</li>
                <li style="margin-bottom: 5px;"><strong>Tilang Elektronik (E-Tilang):</strong> Apabila terkena E-Tilang,
