        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <span class="mt-1 px-3 py-1 rounded-full text-sm font-semibold {{ $booking->status_badge }}">
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <div class="space-y-2">
                        @if($booking->status == 'pending')
                        <form action="{{ route('admin.bookings.approve', $booking->id) }}" method="POST" class="w-full">
                            @csrf
                            <button type="submit" class="w-full bg-green-500 text-white py-2 rounded hover:bg-green-600 flex items-center justify-center">
                                <i class="fas fa-check mr-2"></i>Approve Booking
                            </button>
                        </form>
                        
                        <button onclick="showRejectModal()" class="w-full bg-red-500 text-white py-2 rounded hover:bg-red-600 flex items-center justify-center">
                            <i class="fas fa-times mr-2"></i>Tolak Booking
                        </button>
                        @endif
                        
                        @if($booking->status == 'approved')
                        <form action="{{ route('admin.bookings.complete', $booking->id) }}" method="POST" class="w-full">
                            @csrf
