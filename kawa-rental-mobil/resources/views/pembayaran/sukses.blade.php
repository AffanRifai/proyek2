...
@section('content')
    <div class="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 flex items-center justify-center px-4 py-10">
        ...
        <div class="bg-white shadow-xl rounded-2xl w-full max-w-lg p-8 text-center relative overflow-hidden">
            ...
            <div class="flex flex-col gap-3">
                ...
                <a href="{{ route('transaksi.nota', $pembayaran->id) }}"
                    ...
                    <i class="fas fa-home"></i> Selanjutnya
                </a>
            </div>
